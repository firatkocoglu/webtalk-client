...
const YourBlogs = () => {
  ...
  const fetchDrafts = async () => {
    const response = await axios.get('https://52.28.57.99:8000/api/drafts/', {
  ...
  const fetchAllBlogs = async () => {
    const response = await axios.get(
      'https://52.28.57.99:8000/api/blogs/?by_user&no_page',
      {
        withCredentials: true,
        headers: {
          'X-CSRFToken': session,
  ...
  const deleteDraft = async (id) => {
    try {
      await axios.delete(`https://52.28.57.99:8000/api/drafts/${id}/`, {
        withCredentials: true,
  ...
  const deleteBlog = async (id) => {
    try {
      await axios.delete(`https://52.28.57.99:8000/api/blogs/${id}/`, {
        withCredentials: true,
        headers: { 'X-CSRFToken': session },
      });
